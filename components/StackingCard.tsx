...
export const StackingCard: React.FC<StackingCardProps> = ({ feature, index, total }) => {
  // 優化堆疊位置：讓卡片在滾動時有層次地重疊
  // 基礎偏移量設為 100，每張卡片遞增 40px，形成乾淨的階梯式堆疊
      ...
      <div className="course-card-bg rounded-[1.2rem] md:rounded-[2rem] p-4 md:p-8 mb-3 md:mb-4 shadow-[0_-20px_50px_rgba(0,0,0,0.9)] border border-white/5 backdrop-blur-xl group transition-transform duration-500 hover:scale-[1.01]">
        <div className="flex items-center gap-3 md:gap-10">
          ...
          <div className="flex-1 relative">
            ...
            {/* Chapter Label */}
            <span className="text-gray-500 text-[8px] md:text-xs uppercase tracking-[0.3em] md:tracking-[0.4em] font-black block mb-0.5 md:mb-1 opacity-50">Chapter</span>
